[[Overview]]
== Overview
This Engineering Report focuses on the findings of the first Citizen Science Interoperability Experiment. The experiment applied the approach explained in the OGC SWE4CS discussion paper in several citizen observatories and tested the interoperability of services and clients.

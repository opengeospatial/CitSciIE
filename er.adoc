...
:workingGroup: Spatial Data on the Web Working Group
...
include::6-tiles.adoc[]

include::7-features.adoc[]

include::8-styles.adoc[]

include::9-other.adoc[]

include::10-implementation.adoc[]

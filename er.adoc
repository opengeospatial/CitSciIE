...
:title: OGC Citizen Science engeneering report
...
include::5-apply-OandM.adoc[]

include::6-setup-SOS.adoc[]

include::7-SOS-client.adoc[]

include::8-data-quality-with-SOS.adoc[]

include::9-vocabularies.adoc[]

include::10-SSO.adoc[]

include::11-CitSci-GEOSS.adoc[]

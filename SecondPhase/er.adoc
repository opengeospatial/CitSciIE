...
:title: OGC Citizen Science Interoperability Experiment Second Engineering Report
...
include::5-API-proliferation.adoc[]

include::6-SOS-STA-model.adoc[]

include::7-STA-server.adoc[]

include::8-STA-client.adoc[]

include::9-vocabularies.adoc[]
